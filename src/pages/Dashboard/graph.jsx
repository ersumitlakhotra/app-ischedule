...
const AreaChart = ({ series, color, categoriesArray }) => {
    return (
        <Chart
            options={{
                xaxis: {
...
const AreaChartCard = ({ categoriesArray, series, secondSeries, color, name }) => {
    return (
        <Chart
            options={{
                xaxis: {
...
const PieChartServices = ({ services = [], colors = [] }) => {
    const labels = services.map((service) => service.name);
    const series = services.map((service) => service.bookings);
            ...
            options={{
                ...
                tooltip: {
                    custom: function ({ seriesIndex }) {
                        const service = services[seriesIndex];
                            ...
                            <div class="px-3 py-2 bg-white">
                                ...
                                <div class="text-xs text-slate-600">
                                    ...
                                    <span class="font-semibold text-green-600">
                                        $${Number(service?.revenue || 0).toFixed(2)}
                                    </span>
                                </div>
                            </div>
                        `;
...
export { AreaChart, BarChart, PieChart, PieChartServices, StackedBarChart, AreaChartCard }