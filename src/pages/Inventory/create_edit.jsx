...
export const Inventory_Create_Edit = () => {
   ...
   useEffect(() => {
    ...
    const steps = [
        { id: 1, label: "Product Info", icon: BriefcaseBusiness, content: <ProductInfo form={form} setForm={setForm} image={image} setImage={setImage} categoryList={categoryList} /> },     
    ];
        ...
        switch (step) {
            case 1: {
                ...
                if (maxStock < minStock) {
                    errors.push("Max Stock cannot be less than Min Stock.");
                }
    ...
    return (
        <Modal open={true} message={message} messageType="error" children={
            <>
                <HeaderModal
                    Title={isEdit ? 'Edit Product Detail' : `Create New Product`}
                    Description={`${isEdit ? 'Edit' : 'Add'} an inventory item by providing its product information, pricing, and stock details.`}
