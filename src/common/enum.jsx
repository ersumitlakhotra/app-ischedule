...
export const APPOINTMENT_STATUS_OPTIONS = [
  {id:0, value: "All Status", label: <Badge color="blue" text="All Status" />,color:'blue'},
  {id:1, value: "Awaiting", label: <Badge color="gray" text="Awaiting" />,color:'gray'},
  {id:2, value: "Pending", label: <Badge color="yellow" text="Pending" />,color:'yellow'},
  {id:3, value: "Completed", label: <Badge color="green" text="Completed" />,color:'green' },
  {id:4, value: "Cancelled", label: <Badge color="red" text="Cancelled" />,color:'red' },
  {id:5, value: "Rejected", label: <Badge color="red" text="Rejected" />,color:'red' },
  {id:6, value: "NoShow", label: <Badge color="red" text="No Show" />,color:'red' },
];
